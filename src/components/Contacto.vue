<template>
  <div class="container">
    ...
    <!-- Nueva Card para la ubicación -->
    <div class="location-card">
      <h2>Ubicación del Hotel JW Marriott</h2>
...
const submitForm = () => {
  console.log('Datos del Hotel:', hotelData.value);
};
</script>
...
.container {
  ...
  max-width: 800px; /* Limitar el ancho total del contenedor */
  margin: 50px auto;
}

.hotel-form,
.location-card {
  flex: 1; /* Permitir que ambos elementos ocupen el mismo espacio */
  padding: 2em;
...
.map-container {
  ...
  overflow: hidden;
  border-radius: 10px;
  border: 3px solid #ffcc00; /* Borde decorativo */
  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.5);
  background: url('https://images.unsplash.com/photo-1561301232-e8dca601bdb0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwyMDg5NzR8MHwxfGFsbHwxfHx8fHx8fHwxNjE3MzE3ODQz&ixlib=rb-1.2.1&q=80&w=1080') no-repeat center center;
  background-size: cover; /* Fondo exótico */
}
